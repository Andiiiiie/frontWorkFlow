...
@Component({
  ...
  styleUrl: './process-perform.component.css'
})
export class ProcessPerformComponent  implements OnInit{
    ...
    constructor(private route: ActivatedRoute,private cdr: ChangeDetectorRef,private router:Router,private processService:ProcessService,private exceptionResultService:ExceptionResultService) { }
